  ...
  return (
    <section className="flex lg:flex-row flex-col-reverse gap-5 relative z-0 max-w-[1440px] justify-center items-center mx-auto  text-primary-blue-100 h-fit mb-10">
      <div className="flex-[1.5] padding-x grid gap-6">
        <div className="flex flex-grow  flex-col xl:text-6xl mt:48 text-[32px] md:text-5xl  font-bold tracking-wide lg:tracking-wider letter-shadow  h-2/3   lg:mt-52">
          <h1>
        ...
        <p className="text-primary-blue-300 letter-shadow pb-4 text-lg ">
      ...
      <div className="xl:flex-1 flex justify-end items-end md:w-4/5 w-full lg:w-[480px] xl:h-fit md:mt-60 ">
        <div className="relative xl:w-[570px] mx-2 xs1:w-full  xl:h-[450px] xs1:mt-56 w-[350px]  justify-center mt-48 md:-mt-10 my-auto h-[320px] z-0 ">
          <Image
            src="/salad.png"
            alt="hero"
            fill
